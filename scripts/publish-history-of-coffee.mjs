...
<p>The first solid written evidence of anyone actually cultivating and brewing coffee comes from Yemen, about 600 years ago, in the 1400s, just across the Red Sea from Ethiopia. Sufi Muslim monks there brewed it to stay alert through long nights of prayer &mdash; coffee&rsquo;s first job, essentially, was as a tool for staying awake on purpose.</p>
<p>Within a few generations, coffee beans were shipping out from Yemen through one port: Mocha. For a long stretch, Mocha was the <em>only</em> place in the world coffee legally left from, which is why &ldquo;mocha&rdquo; still means coffee today, centuries after the port stopped being the center of anything.</p>
...
<p>Coffee didn&rsquo;t become America&rsquo;s default hot drink through gradual popularity, though &mdash; it happened almost overnight, for political reasons. After the Boston Tea Party in 1773, when colonists dumped a British tea shipment into Boston Harbor to protest taxation, drinking tea started to look like siding with the British, and coffee became the patriotic choice instead. Local tradition holds that the Tea Party itself was plotted inside the Green Dragon &mdash; though historians aren&rsquo;t actually certain where the planning happened, and some evidence points instead to the print shop of Benjamin Edes, publisher of the Boston Gazette. Coffee was already cheaper and more available than tea in the colonies before any of this &mdash; but the Tea Party is the moment usually credited with locking in America&rsquo;s coffee habit for good, the same habit behind that 66%-of-adults-daily number from the start of this article.</p>
...
<p>Worth flagging before moving to the science: every plant in this entire story, from Ethiopia to Boston, was the same species &mdash; <span style="color:#a0785a;font-weight:700">Arabica</span>. Coffee&rsquo;s other major species, <span style="color:#6b3410;font-weight:700">Robusta</span>, wasn&rsquo;t discovered until the 1890s, in Africa&rsquo;s Congo Basin &mdash; a completely separate story that only later merged into the same cup, as the next section explains.</p>
...
<p>A quick definition, since the word gets thrown around loosely: &ldquo;high acidity&rdquo; in a coffee review doesn&rsquo;t mean sour &mdash; it means bright, lively flavor, the way a squeeze of lemon perks up a dish. Arabica generally has more of this brightness, which is part of what people mean by &ldquo;more complex.&rdquo;</p>
<div data-widget="bar-compare" data-eyebrow="Caffeine by species" data-caption="Robusta packs close to double the caffeine of Arabica — which is exactly why it's a common ingredient in instant coffee and some espresso blends that want a stronger kick." data-value-prefix="" data-value-suffix="%" data-accent-color="#a0785a" data-items='${SPECIES_CAFFEINE}'></div>
