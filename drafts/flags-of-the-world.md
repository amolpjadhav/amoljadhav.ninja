...
Filter that by family. The Nordic cross goes from a fact you have read to one
idea copied six times, sitting in a row.

## Then the oddballs

Rules are easier to remember when you know what breaks them.

**Nepal** is the only flag in the world that is not a rectangle. It is two
stacked triangles, like two pennants on top of each other.

**Switzerland and the Vatican** are the only two square flags. Everybody else
is wider than they are tall.

**Paraguay** puts a different emblem on the front and the back, so the two
sides of the flag do not match. No other country does that.

**Cyprus and Kosovo** are the only flags showing a map of themselves. Both were
...
**Chad and Romania** have the same flag. Three vertical bands, blue, yellow,
red. The only difference is that Chad's blue is slightly darker. Chad has
raised it at the United Nations. Nothing has changed.

**Indonesia and Monaco** are both a red band above a white band. Indonesia's is
longer, and that is the whole difference.
