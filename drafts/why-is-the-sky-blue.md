...
<div style="height:8px;border-radius:9999px;margin:8px 0 20px;background:linear-gradient(90deg,#ef4444,#f97316,#eab308,#22c55e,#3b82f6,#8b5cf6);"></div>
...
<div data-widget="wavelength-wave"></div>
...
<div data-widget="scattering-demo"></div>
...
<div data-widget="sky-scattering" data-initial-slider="0"></div>
...
|---|---|
| **Variables: S and A** | Sunlight is every color at once; air is a thin, unbelievably crowded blanket of molecules. |
| **Rule 1: wave size** | Blue = short, choppy waves. Red = long, lazy waves. |
| **Rule 2: the pinball rule** | Short waves scatter constantly; long waves barely do. |
